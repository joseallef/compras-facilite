...
import { LogoutOverlay } from "@/features/auth/components/logout-overlay";
...
export function Header() {
  ...
  return (
    <>
                      ...
                      >
                        ...
                        <div className="p-2">
                          <Button
                            ...
                            className="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
                          >
      ...
      <AnimatePresence>
        {isLoggingOut && (
          <LogoutOverlay onComplete={() => setIsLoggingOut(false)} />
        )}
      </AnimatePresence>
    </>
  );
