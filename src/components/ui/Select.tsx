...
export const Select = forwardRef<HTMLDivElement, SelectProps>(function Select(
  ...
  return (
    <div className={cn("space-y-2 relative", containerClassName)} ref={containerRef}>
      {label && (
        <label
          htmlFor={id}
      ...
      <div className={cn("relative", className)}>
        <button
          ...
          className={cn(
            "w-full flex items-center bg-background border rounded-xl py-3 outline-none transition-all cursor-pointer disabled:cursor-not-allowed disabled:opacity-50",
            leftIcon ? "pl-12" : "pl-4",
            "pr-12 text-left",
            error
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute z-[100] w-full mt-2 bg-card border border-border rounded-2xl shadow-2xl overflow-hidden py-2"
            >
